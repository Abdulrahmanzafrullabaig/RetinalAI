...
import { Calendar, User, Plus, RefreshCcw } from 'lucide-react';
...
const Appointments = () => {
  ...
  const fetchData = async () => {
    ...
    setError('');
    try {
      const appResponse = await fetch(`${API_URL}/api/appointments`, {
        method: 'GET',
        credentials: 'include',
      });
      if (appResponse.ok) {
      ...
      const docResponse = await fetch(`${API_URL}/api/doctors`, {
        method: 'GET',
        credentials: 'include',
      });
      if (docResponse.ok) {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-primary-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-primary-900 bg-white"
                      required
                    >
                      <option value="" className="text-gray-500">Select a doctor</option>
                      {availableDoctors.map((doctor) => (
                        <option key={doctor.id} value={doctor.id} className="text-primary-900">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="09:00" className="text-primary-900">9:00 AM</option>
                        <option value="10:00" className="text-primary-900">10:00 AM</option>
                        <option value="11:00" className="text-primary-900">11:00 AM</option>
                        <option value="12:00" className="text-primary-900">12:00 PM</option>
                        <option value="13:00" className="text-primary-900">1:00 PM</option>
                        <option value="14:00" className="text-primary-900">2:00 PM</option>
                        <option value="15:00" className="text-primary-900">3:00 PM</option>
                        <option value="16:00" className="text-primary-900">4:00 PM</option>
                        <option value="17:00" className="text-primary-900">5:00 PM</option>
                      </select>
                    </div>
                  </div>
                  <div>
