...
const ClinicalPredict: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/api/predict-clinical`, {
                method: 'POST',
                headers: {
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-8">
                        <button
                            ...
                            className="flex items-center text-gray-900 hover:text-primary-600 font-medium mb-4 transition-colors"
                        >
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-primary-100 p-8 mb-8">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full p-3 border-2 border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all bg-white"
                                    />
                                </div>
                                <div>
                                    <label htmlFor="HbA1c" className="block text-sm font-semibold text-gray-900 mb-2">
                                        HbA1c (%):
                                    </label>
                                    <input
                                        type="number"
                            ...
                            <div className="grid sm:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full p-3 border-2 border-gray-300 rounded-lg appearance-none bg-white text-gray-900 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all cursor-pointer pr-10"
                                        >
                                ...
                                <div>
                                    <label htmlFor="Stage" className="block text-sm font-semibold text-gray-900 mb-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            ...
                                            <option value="Proliferative" className="text-gray-900">Proliferative</option>
                                        </select>
                                        <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 pointer-events-none" />
                                    </div>
                                </div>
                                <div>
                                    <label htmlFor="Blood_Pressure" className="block text-sm font-semibold text-gray-900 mb-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            ...
                                            <option value="Prehypertension" className="text-gray-900">Prehypertension</option>
                                            <option value="Hypertension Stage 1" className="text-gray-900">Hypertension Stage 1</option>
                                            <option value="Hypertension Stage 2" className="text-gray-900">Hypertension Stage 2</option>
                                        </select>
                                        <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 pointer-events-none" />
                                    </div>
                                </div>
                            ...
                            <div className="pt-4 border-t border-gray-200">
                                ...
                                <div className="grid sm:grid-cols-3 gap-4">
                                    {comorbidityOptions.map((comorbidity) => (
                                        <label key={comorbidity} className="flex items-center space-x-2 text-gray-900 text-sm cursor-pointer hover:text-primary-600 transition-colors">
                                            <input
                                                type="checkbox"
                    ...
                    {result && (
                        <div className="bg-white rounded-2xl shadow-lg border border-primary-100 p-8">
                            ...
                            {/* Main Result */}
                            <div className={`p-6 rounded-xl border-2 text-center mb-6 ${result.risk_level === 'High'
